...
resource "aws_iam_role" "this" {
  name        = substr("${var.aws_resource_name_prefix}${var.name}-${var.environment}-aws-load-balancer-controller", 0, 64)
...
resource "aws_iam_policy" "this" {
  name        = "${var.aws_resource_name_prefix}${var.name}-${var.environment}-alb-management"
